...
"""
.. module:: calculation.acc_LibGergCalc
...
if (isInstalled):   # Dlls accessible
    ...
    # Lib functions
    prepare_gas = CalcDll.__gerglib_MOD_prepare_gas

    calc_realgasfactor_z = CalcDll.__gerglib_MOD_calc_realgasfactor_z
    calc_compressibility_k = CalcDll.__gerglib_MOD_calc_compressibility_k
    calc_compressibility_kt = CalcDll.__gerglib_MOD_calc_compressibility_kt
    calc_compressibility_kp = CalcDll.__gerglib_MOD_calc_compressibility_kp
    calc_rho = CalcDll.__gerglib_MOD_calc_rho
    calc_eos_rho = CalcDll.__gerglib_MOD_calc_eos_rho
    calc_cv = CalcDll.__gerglib_MOD_calc_cv
    calc_cp = CalcDll.__gerglib_MOD_calc_cp
    calc_kappa = CalcDll.__gerglib_MOD_calc_kappa
    calc_csound = CalcDll.__gerglib_MOD_calc_csound
